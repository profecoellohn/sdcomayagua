...
## Novedades v54
- Nueva estructura en escritorio con menú lateral.
- Catálogo reorganizado con filtros a la izquierda y productos a la derecha.
- Inicio más compacto y menos vacío.
- Mejor distribución para laptop y monitor grande.


## Estructura de páginas separadas

Esta versión separa las secciones principales en archivos HTML reales:
...
- `finanzas.html` = Panel financiero

Archivos nuevos de apoyo:

- `assets/css/pages.css` = estilos del menú con enlaces reales
- `assets/js/pages-router.js` = redirección entre páginas cuando un botón interno llama a otra sección
- `assets/js/pages/` = configuración JS independiente para cada página

El archivo `sw.js` también fue actualizado para que GitHub Pages no cargue la versión vieja en caché.
