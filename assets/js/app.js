...
const ahora = new Date();
        ...
        function renderizarProductos(arr) {
            ...
            arr.forEach(prod => {
                ...
                const chipPromo = (prod.promos && prod.promos.length) ? `<span class="card-chip">Con promo</span>` : `<span class="card-chip" style="background: rgba(148, 163, 184, 0.14); border-color: rgba(148, 163, 184, 0.18); color: #e2e8f0;">En stock</span>`;
                cont.innerHTML += `
                    ...
                    cont.innerHTML += `
                        <div class="cot-card">
                            ...
                            <div class="cot-actions">
                                <button class="btn-block btn-recuperar" onclick="cargarCot(${c.id})">Recuperar al carrito</button>
                                <button class="btn-cot-wa" onclick="whatsappCotizacion(${c.id})" title="Enviar por WhatsApp">WA</button>
