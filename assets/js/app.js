...
const ahora = new Date();
        ...
        function obtenerImagenProducto(prod = {}, variante = null, formato = 'card', estadoManual = '') {
            ...
            return obtenerImagenCategoriaBase(prod?.categoria || 'General', prod?.nombre || 'Producto', estado, formato);
        }

        function restaurarFallbackProducto(imgEl, categoria = '', nombre = 'Producto', estado = 'en-stock', formato = 'card') {
            if(!imgEl) return;
            imgEl.onerror = null;
            imgEl.src = obtenerImagenCategoriaBase(categoria, nombre, estado, formato);
